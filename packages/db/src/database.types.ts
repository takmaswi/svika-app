  ...
  public: {
    Tables: {
      ...
      demo_commute_fixtures: {
        ...
        Relationships: [
          {
            foreignKeyName: "demo_commute_fixtures_profile_id_fkey"
            columns: ["profile_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "demo_commute_fixtures_ticket_id_fkey"
            columns: ["ticket_id"]
            isOneToOne: true
            referencedRelation: "ticket_status"
            referencedColumns: ["ticket_id"]
      ...
      guardian_link_attempts: {
        ...
        Relationships: [
          {
            foreignKeyName: "guardian_link_attempts_rider_id_fkey"
            columns: ["rider_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      place_events: {
        Row: {
          ...
          detail: Json
          id: number
          kind: Database["public"]["Enums"]["place_event_kind"]
        ...
        Relationships: [
          {
            foreignKeyName: "place_events_place_name_id_fkey"
          ...
          },
          {
            ...
            columns: ["place_name_id"]
            isOneToOne: false
            referencedRelation: "place_names_live"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "place_events_shortcut_id_fkey"
            columns: ["shortcut_id"]
            isOneToOne: false
            referencedRelation: "shortcut_paths"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "place_events_shortcut_id_fkey"
            columns: ["shortcut_id"]
            isOneToOne: false
            referencedRelation: "shortcut_paths_live"
            referencedColumns: ["id"]
          },
        ]
      }
      place_names: {
        Row: {
          ...
          scope: Database["public"]["Enums"]["place_scope"]
        }
        Insert: {
          accepted_from?: string | null
          author_id?: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "place_names_accepted_from_fkey"
            columns: ["accepted_from"]
            isOneToOne: false
            referencedRelation: "place_names"
            referencedColumns: ["id"]
          },
          ...
          {
            foreignKeyName: "place_names_author_id_fkey"
            columns: ["author_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "place_names_promoted_from_fkey"
            columns: ["promoted_from"]
            isOneToOne: false
            referencedRelation: "place_names"
            referencedColumns: ["id"]
          },
      ...
      place_reports: {
        ...
        Relationships: [
          {
            foreignKeyName: "place_reports_place_name_id_fkey"
            columns: ["place_name_id"]
            isOneToOne: false
            referencedRelation: "place_names"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "place_reports_reporter_id_fkey"
            columns: ["reporter_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      place_submission_attempts: {
        ...
        Relationships: [
          {
            foreignKeyName: "place_submission_attempts_rider_id_fkey"
            columns: ["rider_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      shortcut_paths: {
        ...
        Relationships: [
          {
            foreignKeyName: "shortcut_paths_author_id_fkey"
            columns: ["author_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "shortcut_paths_promoted_from_fkey"
            columns: ["promoted_from"]
            isOneToOne: false
            referencedRelation: "shortcut_paths"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "shortcut_paths_source_journey_id_fkey"
      ...
      trip_walk_tails: {
        ...
        Relationships: [
          {
            foreignKeyName: "trip_walk_tails_rider_id_fkey"
            columns: ["rider_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "trip_walk_tails_ticket_id_fkey"
            columns: ["ticket_id"]
            isOneToOne: true
            referencedRelation: "ticket_status"
            referencedColumns: ["ticket_id"]
    ...
    Views: {
      ...
      place_names_live: {
        Row: {
          ...
          id: string | null
          kind: Database["public"]["Enums"]["place_kind"] | null
          lat: number | null
          lng: number | null
          name: string | null
          scope: Database["public"]["Enums"]["place_scope"] | null
        }
        Insert: {
          created_at?: string | null
          id?: string | null
    ...
    Functions: {
      ...
      demo_float_mine: { Args: { p_target_cents: number }; Returns: undefined }
      demo_reset_all: { Args: never; Returns: number }
      demo_reset_mine: {
        Args: { p_consent_version: string }
        Returns: undefined
      }
      demo_watchdog_set_day: { Args: { p_variant: string }; Returns: string }
      discard_rider_journey: { Args: { p_journey: string }; Returns: undefined }
      flag_journey_shortcut: {
        Args: { p_journey: string }
        Returns: {
          outcome: string
          shortcut_id: string
      ...
      mark_ticket_arrived: { Args: { p_ticket: string }; Returns: undefined }
      my_demo_since: { Args: never; Returns: string }
      my_family_links: {
        Args: never
        Returns: {
          confirmed_at: string
      ...
      report_place_name: {
        Args: { p_place: string; p_reason?: string }
        Returns: {
          outcome: string
        }[]
      }
      ...
      revoke_guardian_link: { Args: { p_link: string }; Returns: undefined }
      ...
      run_places_promotion: { Args: never; Returns: Json }
      ...
      submit_place_name: {
        Args: {
          ...
          p_kind: Database["public"]["Enums"]["place_kind"]
          p_lat: number
          p_lng: number
          p_name: string
        }
    ...
    Enums: {
      ...
      ledger_txn_kind:
        ...
        | "transfer_claim"
        | "transfer_cancel"
      place_event_kind: "promoted_suggested" | "promoted_public" | "hidden"
      place_kind: "stop" | "place" | "gate" | "landmark"
      place_scope: "personal" | "suggested" | "public"
